...
_lr_goto_items = {'body':([0,],[1,]),'semantica_lista_add':([0,],[2,]),'semantica_casting_float_to_int':([0,],[3,]),'semantica_stack':([0,],[4,]),'add_queue':([0,],[5,]),'cast_float_to_int':([0,42,],[6,57,]),'to_upper_case':([0,],[7,]),'lista_add':([0,],[8,]),'operacionesStack':([0,],[11,]),'add_lista':([0,],[14,]),'add_stack':([0,],[15,]),'pop_stack':([0,26,],[16,33,]),'stack_push':([0,],[17,]),'stack_pop':([0,26,],[18,18,]),'valor':([36,37,],[44,52,]),'numero':([36,37,],[46,46,]),'cast_float_int':([42,],[56,]),}
...
_lr_productions = [
  ...
  ('body -> semantica_lista_add','body',1,'p_body','semantico.py',8),
  ('body -> semantica_casting_float_to_int','body',1,'p_body','semantico.py',9),
  ('body -> semantica_stack','body',1,'p_body','semantico.py',10),
  ('body -> add_queue END_OF_LINE','body',2,'p_body','semantico.py',11),
  ('body -> cast_float_to_int END_OF_LINE','body',2,'p_body','semantico.py',12),
  ('body -> to_upper_case END_OF_LINE','body',2,'p_body','semantico.py',13),
  ...
  ('semantica_lista_add -> lista_add END_OF_LINE','semantica_lista_add',2,'p_semantica_lista_add','semantico.py',76),
  ('lista_add -> add_lista','lista_add',1,'p_lista_add','semantico.py',79),
  ('semantica_casting_float_to_int -> FLOAT_TYPE IDENTIFICADOR IGUAL FLOAT END_OF_LINE cast_float_int','semantica_casting_float_to_int',6,'p_semantica_casting_float_to_int','semantico.py',82),
  ...
  ('cast_float_int -> cast_float_to_int','cast_float_int',1,'p_cast_float_int','semantico.py',85),
